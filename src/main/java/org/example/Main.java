...
import org.example.algoritmsearche.Searche;
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            if(colum < 0){
                ...
                Cache cache = new Cache("./src/main/java/org/example/airports.csv", colum);
                ...
                while(true){
                    ...
                    if(searchString.isEmpty()){
                        ...
                        Searche search = new Searche(cache, searchString);
